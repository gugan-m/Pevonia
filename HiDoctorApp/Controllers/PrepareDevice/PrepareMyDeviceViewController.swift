...
class PrepareMyDeviceViewController: UIViewController
{
    ...
    struct apiMessageName
    {
        ...
        static let TourPlannerHeader = "Tour Planner"
        static let TourPlannerSFC = "Tour Planner SFC"
        static let TourPlannerDoctor = "Tour Planner \(appDoctorPlural)"
        static let TourPlannerAccompanist = "Tour Planner Accompanist"
        static let TourPlannerProduct = "Tour Planner Products"
        static let DCRCalendarDetails = "DCR Calendar Details"
        static let DCRLockDetails = "DCR Lock Details"
        static let DCRHeaderDetails = "DCR Details"
        static let DCRTravelledPlacesDetails = "DCR SFC"
        static let DCRAccompanistDetails = "DCR Accompanist"
        static let DCRDoctorVisitDetails = "DCR \(appDoctor) Visit"
        static let DCRDoctorVisitOrderDetails = "DCR \(appDoctor) Visit Order Details"
        static let DCRChemistVisitOrderDetails = "DCR \(appChemist) Visit Order Details"
        static let DCRSampleDetails = "DCR Sample Details"
        static let DCRDetailedProducts = "DCR Detailed Products"
        static let DCRChemistVisitDetails = "DCR \(appChemist) Visit"
        static let DCRRCPADetails = "DCR RCPA"
        static let DCRCustomerFollowUpDetails = "DCR Customer Follow-Up"
        static let DCRAttachmentDetails = "DCR Attachment"
        static let DCRStockistVisitDetails = "DCR \(appStockiest) Visit"
        static let DCRExpenseDetails = "DCR Expense"
        static let CampaignPlannerDoctor = "Accompanist's \(appCp) \(appDoctor)"
        static let AccompanistCampaignPlannerSFC = "Accompanist's \(appCp) SFC"
        static let AccopmanistCampaignPlannerHeader = "Accompanist's \(appCp)"
        static let AccompanistSFCData = "Accompanist's SFC"
        static let AccompanistData = "Accompanist's \(appDoctor) Data"
        static let HolidayMaster = "Holiday Master"
        static let AttendanceActivities = "Attendance Details"
        static let CompetitorProducts = "Competitor Products"
        static let DoctorAccompanist = "\(appDoctor) Accompanist"
        static let UserTypeMenuAccess = "Menu Access"
        static let AssetMasterDetails = "Asset Master Details"
        static let AssetTagDetails = "Asset Tag Details"
        static let AssetsPartsDetails = "Assets Parts Details"
        static let AssetsAnalyticsDetails = "Assets Analytics Details"
        static let StoryDetails = "Story Details"
        static let AssetProductMapping = "Asset Product Details"
        static let DoctorProductMapping = "\(appDoctor) Product Mapping"
        static let MCDoctorProductMapping = "MC \(appDoctor) Product Mapping"
        static let DCRChemistAccompanist = "DCR \(appChemist) Accompanist"
        static let DCRChemistSamplePromotion = "DCR \(appChemist) SamplePromotion"
        static let DCRChemistDetailedProductsDetails = "DCR \(appChemist) DetailedProductsDetails"
        static let DCRChemistRCPAOwnProductDetails = "DCR \(appChemist) RCPA Own Product Details"
        static let DCRChemistRCPACompetitorProductDetails = "DCR \(appChemist) RCPA Competitor Product Details"
        static let DCRChemistDayFollowups = "DCR \(appChemist) Followups"
        static let DCRChemistDayAttachments = "DCR \(appChemist) Attachments"
        ...
        static let DCRMCActivity = "DCR Activity Details"
        static let CustomerAttendanceMarketingActivity = "Customer Marketing Campaign Activity"
        static let DCRAttendanceMCActivity = "DCR Activity Details"
        static let DCRCOMPETITOR = "DCR Competitor Details"
        static let COMPETITOR = "Competitor"
        static let COMPETITORPRODUCT = "Competitor Products"
        static let AttendanceSample = "Attendance Samples"
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        {
            self.loadingLbl.text = "Downloading accompanist data..."
        }
    }
