...
//    }
    ...
    func mailComposeController(_ controller: MFMailComposeViewController, didFinishWith result: MFMailComposeResult, error: Error?)
    {
        if result ==  MFMailComposeResult.sent
        {
            ...
            AlertView.showAlertView(title: "Success", message: "Your message has been sent to HiDoctor support team successfully. HiDoctor support team will contact you shortly.")
        }
