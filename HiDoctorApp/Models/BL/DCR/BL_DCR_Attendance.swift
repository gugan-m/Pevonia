...
class BL_DCR_Attendance: NSObject
{
    ...
    func saveDCRAttendanceActivity1(Project_Code: String,Activity_Code:String, startTime: String, endTime: String, remarks: String, dcrId: Int)
    {
        let dcrAttendanceActivityDict: NSDictionary = ["DCR_Id":dcrId, "DCR_Actual_Date": convertDateIntoServerStringFormat(date: getDCRDate()), "Project_Code":Project_Code , "Activity_Code": Activity_Code, "Start_Time": startTime, "End_Time": endTime, "Remarks": remarks]
        let objAttendaceActivity: DCRAttendanceActivityModel = DCRAttendanceActivityModel(dict: dcrAttendanceActivityDict)
