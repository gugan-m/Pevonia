...
class BL_DCR_Refresh: NSObject
{
    ...
    {
        static let DCRLockLeave = "DCR Lock leave"
        static let DCRCalendarData = "DCR Calendar"
        static let DCRHeaderData = "DCR Header"
        static let DCRAccompanistData = "DCR Accompanist"
        static let DCRTravelledPlaces = "DCR Travelled places"
        static let DCRDoctorVisitDetails  = "DCR \(appDoctor) visit details"
        static let DCRDoctorAccompanist = "DCR \(appDoctor) accompanist"
        static let DCRSampleDetails = "DCR Sample details"
        static let DCRDetailedProducts = "DCR Detailed products"
        static let DCRChemistVisit = "DCR \(appChemist) visit"
        static let DCRChemistDayVisits = "DCR \(appChemist)Day Visits"
        static let DCRChemistAccompanist = "DCR \(appChemist) Accompanist"
        static let DCRChemistSamplePromotion = "DCR \(appChemist)t SamplePromotion"
        static let DCRChemistDetailedProductsDetails = "DCR \(appChemist) DetailedProducts Details"
        static let DCRChemistRCPAOwnProductDetails = "DCR \(appChemist) RCPAOwn ProductDetails"
        static let DCRChemistRCPACompetitorProductDetails = "DCR \(appChemist) RCPACompetitor ProductDetails"
        static let DCRChemistDayFollowups = "DCR \(appChemist) Followups"
        static let DCRChemistDayAttachments = "DCR \(appChemist) Attachments"
        static let DCRDoctorPOB = "DCR \(appDoctor) POB"
        static let DCRChemistPOB = "DCR \(appChemist) POB"
        static let DCRRCPADetails = "DCR RCPA details"
        static let DCRFollowUpDetails = "DCR FollowUp Details"
        static let DCRAttachmentDetails = "DCR Attachment details"
        static let DCRStockiestDetails = "DCR Stockiest details"
        static let DCRExpenseDetails = "DCR Expense details"
        static let DCRAttendanceActivities = "DCR Attendance activities"
        static let DCRUserProducts = "DCR User products"
        static let DCRCallActivity = "DCR Call Activity"
        static let DCRMCActivity = "DCR MC Activity"
        static let AttendanceDCRCallActivity = "Attendance DCR Call Activity"
        static let AttendanceDCRMCActivity = "Attendance DCR MC Activity"
        static let AssetAnalyticsDetails = "AssetAnalyticsDetails"
        static let TPUnfreezeDates = "TP Unfreeze Dates"
        static let DCRCompetitor = "DCR COmpetitor Details"
        static let DCRAttendanceSample = "DCR Attendance Sample Details"
    }
