...
class CustomerMasterPersonalInfo: Record
{
    ...
    init(dict: NSDictionary)
    {
        ...
        if dob != ""
        {
            self.DOB = getStringInFormatDate(dateString:dob)
        }
        let anniversaryDate = checkNullAndNilValueForString(stringData: dict.value(forKey: "Anniversary_Date") as? String)
        if anniversaryDate != ""
        {
            self.Anniversary_Date = getStringInFormatDate(dateString: anniversaryDate)
        }
...
class CustomerMasterPersonalInfoEdit: Record
{
    var Customer_Code: String!
    var Region_Code: String!
    var DOB: Date!
    ...
    var Hospital_Address: String?
    var Notes: String?
    var Photo_Local_Path: String = EMPTY
    ...
    init(dict: NSDictionary)
    {
        ...
        self.Hospital_Address = checkNullAndNilValueForString(stringData: dict.value(forKey: "Hospital_Address") as? String)
        self.Notes = checkNullAndNilValueForString(stringData: dict.value(forKey: "Notes") as? String)
        self.Photo_Local_Path = checkNullAndNilValueForString(stringData: dict.value(forKey: "Photo_Local_Path") as? String)
    ...
    override class var databaseTableName: String
    {
        return MST_CUSOMTER_MASTER_PERSONAL_INFO_EDIT
    }
    ...
    override func encode(to container: inout PersistenceContainer) {
        ...
        container["Hospital_Address"] = Hospital_Address
        container["Notes"] = Notes
        container["Photo_Local_Path"] = Photo_Local_Path
    }
//    var persistentDictionary: [String : DatabaseValueConvertible?]
//    {
//        let dict1: [String : DatabaseValueConvertible?] = [
